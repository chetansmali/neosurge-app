...
import 'widgets/etf_holding_tile.dart';

class ETFHoldingsTab extends StatefulWidget {
  final PortfolioHoldingsModel portfolioHoldingsModel;

  const ETFHoldingsTab({super.key, required this.portfolioHoldingsModel});

  @override
  State<ETFHoldingsTab> createState() => _ETFHoldingsTabState();
}

class _ETFHoldingsTabState extends State<ETFHoldingsTab> {
