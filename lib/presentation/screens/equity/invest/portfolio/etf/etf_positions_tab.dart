...
import 'widgets/etf_positions_tile.dart';

class ETFPositionsTab extends StatefulWidget {
  const ETFPositionsTab({
    super.key,
    required this.portfolioPositionModel,
  });

  final PortfolioPositionModel portfolioPositionModel;

  @override
  State<ETFPositionsTab> createState() => _ETFPositionsTabState();
}

class _ETFPositionsTabState extends State<ETFPositionsTab> {
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: ETFPositionsTile(
                          ...
                          type: displayedPersons[index].transactionType ?? '--',
