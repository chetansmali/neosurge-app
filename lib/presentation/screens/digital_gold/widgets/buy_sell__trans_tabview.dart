...
class BuySellTabTransView extends StatefulWidget {
  const BuySellTabTransView({
    Key? key,
  }) : super(key: key);

  @override
  State<BuySellTabTransView> createState() => BuySellTabTransViewState();
}

class BuySellTabTransViewState extends State<BuySellTabTransView>
    with AutomaticKeepAliveClientMixin<BuySellTabTransView> {
        ...
        Expanded(
          child: BlocBuilder<DgTransactionCubit, DgTransactionState>(
            builder: (context, state) {
              ...
              if (state is DgTransactionLoadError && state.isFirstFetch) {
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        if (index < transactions.length) {
                          if (isGoldSelected != null) {
                            if (isGoldSelected!) {
                              return transactions[index].metalType ==
                                      MetalType.gold
                                  ? Padding(
                                      padding:
