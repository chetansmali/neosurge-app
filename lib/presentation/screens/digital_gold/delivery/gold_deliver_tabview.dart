...
class GoldDeliverTabView extends StatefulWidget {
  const GoldDeliverTabView({Key? key}) : super(key: key);

  @override
  State<GoldDeliverTabView> createState() => _GoldDeliverTabViewState();
}

class _GoldDeliverTabViewState extends State<GoldDeliverTabView>
    with AutomaticKeepAliveClientMixin<GoldDeliverTabView> {
  @override
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Gap(4.0),
                      Text(
                        'Not enough gold balance to buy coins',
