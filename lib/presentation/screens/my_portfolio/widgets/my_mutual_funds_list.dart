...
import 'my_mutual_fund_card.dart';

const _kDuration = Duration(milliseconds: 400);

class MyMutualFundsList extends HookWidget {
  const MyMutualFundsList({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller =
        useMemoized(() => ExpandableSliverListController<UserMfScheme>(
    ...
    return MultiSliver(
      children: [
        BlocBuilder<MfUserHoldingsCubit, MfUserHoldingsState>(
