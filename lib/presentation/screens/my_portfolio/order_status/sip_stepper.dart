...
class SipStepper extends HookWidget {
  final MfOrder mfOrder;

  const SipStepper({Key? key, required this.mfOrder}) : super(key: key);
      ...
      steps: [
        EnhanceStep(
          title: Text(
            ...
            style: isDarkMode ? OrderStyles.finishedStepTitleStyleDark : OrderStyles.finishedStepTitleStyleLight,
          ),
