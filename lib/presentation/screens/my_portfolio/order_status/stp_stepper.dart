...
class StpStepper extends HookWidget {
  final MfOrder mfOrder;

  const StpStepper({Key? key, required this.mfOrder}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return EnhanceStepper(
      ...
      steps: [
        EnhanceStep(
          title: Text(
            'STP Request Placed on Neosurge',
        ...
        if (mfOrder.status == MFOrderStatus.failed) ...[
          ...
          const EnhanceStep(title: Text('STP request processing'), content: SizedBox.shrink(), icon: Icon(Icons.schedule_rounded, color: AppColors.darkOrange)),
        ] else ...[
          EnhanceStep(
            title: const Text('STP Successful'),
