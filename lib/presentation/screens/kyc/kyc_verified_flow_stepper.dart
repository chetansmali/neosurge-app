...
class KycVerifiedFlowStepper extends StatefulWidget {
  const KycVerifiedFlowStepper({Key? key}) : super(key: key);

  @override
  State<KycVerifiedFlowStepper> createState() => _KycVerifiedFlowStepperState();
}

class _KycVerifiedFlowStepperState extends State<KycVerifiedFlowStepper> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _itemScrollController.jumpTo(
          index: context.read<OnboardingPageCubit>().state.pageIndex);
    });
  }
...
class _IconGetter extends StatelessWidget {
  ...
  SvgPicture getIcon(int index) {
    ...
    switch (index) {
      ...
      // case 6:
      //   return Assets.icons.bankCheque.svg(width: 24, height: 24, color: Colors.white);
      case 6:
