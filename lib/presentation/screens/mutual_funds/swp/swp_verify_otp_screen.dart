...
class SwpFundVerifyOtpScreen extends StatefulWidget {
  final SwpOrderResponse swpOrderResponse;

  const SwpFundVerifyOtpScreen({Key? key, required this.swpOrderResponse})
      : super(key: key);

  @override
  State<SwpFundVerifyOtpScreen> createState() => _SwpFundVerifyOtpScreenState();
}

class _SwpFundVerifyOtpScreenState extends State<SwpFundVerifyOtpScreen> {
      ...
      onWillPop: () async {
        return await showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
                'Your swp request will be cancelled if you leave this screen.'),
            actions: <Widget>[
              TextButton(
                    ...
                    children: [
                      ...
                      BlocProvider(
                        ...
                        child: ResendTransactionOtpWidget(
                            ...
                            transactionId: widget.swpOrderResponse.id),
                      ),
                      const Spacer(),
