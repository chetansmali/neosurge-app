...
/// [ModifiedExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [ModifiedExpansionTile].
///
/// {@tool dartpad}
...
class ModifiedExpansionTile extends StatefulWidget {
  ...
  /// The hasTrailing property is used to determine whether the trailing widget
  final bool? hasTrailing;
  @override
  State<ModifiedExpansionTile> createState() => _ModifiedExpansionTileState();
}

class _ModifiedExpansionTileState extends State<ModifiedExpansionTile>
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: ListTile(
              ...
              trailing: widget.hasTrailing ?? true
