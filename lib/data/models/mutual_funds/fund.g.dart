...
Fund _$FundFromJson(Map<String, dynamic> json) => Fund(
      ...
      initialInvestmentMultiples: json['initial_investment_multiples'] as int,
      minAdditionalInvestment:
          (json['min_additional_investment'] as num).toDouble(),
      additionalInvestmentMultiples:
          json['additional_investment_multiples'] as int,
...
Performance _$PerformanceFromJson(Map<String, dynamic> json) => Performance(
      oneM: (json['oneM'] as num).toDouble(),
      oneY: (json['oneY'] as num).toDouble(),
      twoY: (json['twoY'] as num).toDouble(),
      threeM: (json['threeM'] as num).toDouble(),
      threeY: (json['threeY'] as num).toDouble(),
      fiveY: (json['fiveY'] as num).toDouble(),
      sixM: (json['sixM'] as num).toDouble(),
      sevenY: (json['sevenY'] as num).toDouble(),
      nineM: (json['nineM'] as num).toDouble(),
      tenY: (json['tenY'] as num).toDouble(),
    );
...
Map<String, dynamic> _$PerformanceToJson(Performance instance) =>
    <String, dynamic>{
      ...
      'oneY': instance.oneY,
      'twoY': instance.twoY,
      'threeM': instance.threeM,
      'threeY': instance.threeY,
      'fiveY': instance.fiveY,
      'sixM': instance.sixM,
      'sevenY': instance.sevenY,
      'nineM': instance.nineM,
      'tenY': instance.tenY,
    };
