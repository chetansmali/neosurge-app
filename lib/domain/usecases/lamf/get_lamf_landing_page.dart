...
@injectable
class GetLAMFLandingPage
    extends UseCase<GetImportLandingPageResponse, NoParams> {
  final LAMFRepository _lAMFRepository;

  GetLAMFLandingPage(this._lAMFRepository);

  @override
  Future<Either<AppError, GetImportLandingPageResponse>> call(
          NoParams params) =>
      _lAMFRepository.getLAMFLandingPage();
}
