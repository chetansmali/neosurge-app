...
@injectable
class GetCancelledSips extends UseCase<List<SipModel>, UserIdParam> {
  final MutualFundRepository _mutualFundRepository;

  GetCancelledSips(this._mutualFundRepository);

  @override
  Future<Either<AppError, List<SipModel>>> call(UserIdParam params) =>
      _mutualFundRepository.getCancelledSips(params.toJson());
}
