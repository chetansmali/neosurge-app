...
@injectable
class VerifySwpOtp extends UseCase<void, VerifyTransactionOtpParams> {
  final MutualFundRepository _mutualFundRepository;

  VerifySwpOtp(this._mutualFundRepository);

  @override
  Future<Either<AppError, void>> call(VerifyTransactionOtpParams params) =>
      _mutualFundRepository.verifySwpOtp(params.toJson());
}
