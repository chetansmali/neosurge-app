...
@injectable
class VerifySwitchOtp extends UseCase<void, VerifyTransactionOtpParams> {
  final MutualFundRepository _mutualFundRepository;

  VerifySwitchOtp(this._mutualFundRepository);

  @override
  Future<Either<AppError, void>> call(VerifyTransactionOtpParams params) =>
      _mutualFundRepository.verifySwitchOtp(params.toJson());
}
